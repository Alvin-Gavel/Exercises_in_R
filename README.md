This repository contains code I have written as an exercise in learning to program in R, and which happens to give output that's neat to look at. So far, the contents are:
